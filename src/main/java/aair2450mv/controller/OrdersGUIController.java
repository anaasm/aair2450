...
import aair2450mv.gui.OrdersGUI;
import aair2450mv.service.PaymentAlert;
    ...
    private void initData(){
        ...
        payOrder.setOnAction(event -> {
            orderPaymentList= menuData.stream()
                    ...
                    .collect(Collectors.toList());
            totalAmount = orderPaymentList.stream().mapToDouble(e->e.doubleValue()).sum();
